...
class prediction60away extends base {
    constructor() {
        super(30, 45, 64, 15,25,35, 60, 20, 60.00);
    }
    ...
    /* hier we apply the formel from excel for 60% */
    ...
    getCsvByJson(predictionsJson) {
        ...
        predictionsJson.forEach((prediction) => {
            if (
                ...
                parseFloat(prediction.generalResultHomeAway.awayGeneralResult.winningPercentage) >= 70.00
...
module.exports = prediction60away;
